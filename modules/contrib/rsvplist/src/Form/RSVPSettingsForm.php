...
/**
 * Defines a form to configura RSVP List module settings
 */
...
class RSVPSettingsForm extends ConfigFormBase
{
    ...
    public function buildForm(array $form, FormStateInterface $form_state, Request $request = null)
    {
        ...
        $form['rsvplist_types'] = array(
            ...
            '#options' =>$types,
            '#description' => t('On the specified node types, an RSVP
            option will be available and can be enabled while that
